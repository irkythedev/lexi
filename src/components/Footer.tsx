      ...
      <div className="mx-auto flex max-w-[var(--max-grid)] flex-col items-center gap-3 text-center text-[calc(11px*var(--type-scale))] leading-relaxed text-[var(--color-text-3)]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1">
          ...
          <span ref={worksRef} className="relative inline-flex items-center">
            ...
            {showWorks && (
              <span className="absolute bottom-full right-0 z-30 mb-2 flex w-max max-w-[min(15rem,calc(100vw-2rem))] flex-col gap-1 rounded-xl border-2 border-[var(--color-hairline)] bg-[var(--color-surface)] p-1.5 shadow-[var(--shadow-card)]">
                {FOOTER.works.map((w) => (
