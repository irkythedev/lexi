  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-14 z-[70] flex flex-col items-center gap-2 px-4">
      {toasts.map((t) => {
        ...
        return (
          <div key={t.id} role="status" className="pointer-events-auto flex items-center gap-2 rounded-[var(--radius-md)] px-4 py-2 text-[calc(13.5px*var(--type-scale))] font-medium shadow-[var(--shadow-lift)]"
