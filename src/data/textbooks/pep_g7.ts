...
const pepG7: Edition = {
  ...
  stage: '初中',
  region: '全国通用',
  grades: [{ grade: 7, volumes: [{ volume: 1, title: '七年级上册' }] }],
  units: [
    {
      editionId: 'pep_junior_g7_v1', editionName: '人教版 (新目标)', grade: 7, volume: 1, unit: 1,
    ...
    {
      editionId: 'pep_junior_g7_v1', editionName: '人教版 (新目标)', grade: 7, volume: 1, unit: 2,
