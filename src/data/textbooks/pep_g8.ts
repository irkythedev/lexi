...
const pepG8: Edition = {
  ...
  stage: '初中',
  region: '全国通用',
  grades: [{ grade: 8, volumes: [{ volume: 1, title: '八年级上册' }] }],
  units: [
    {
      editionId: 'pep_junior_g8_v1', editionName: '人教版 (新目标)', grade: 8, volume: 1, unit: 1,
    ...
    {
      editionId: 'pep_junior_g8_v1', editionName: '人教版 (新目标)', grade: 8, volume: 1, unit: 2,
