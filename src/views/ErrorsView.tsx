            ...
            <Row key={e.id}>
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2"><button onClick={() => resolve(e.id!)} className="press inline-flex items-center gap-1 rounded-full border border-[var(--color-vocab-border)] bg-[var(--color-vocab-soft)] px-3 py-1 text-[calc(12px*var(--type-scale))] font-semibold text-[var(--color-vocab-deep)]"><CheckCircle2 size={13} /> {t('errorsMarkResolved', locale)}</button></div>
                </div>
              </div>
            </Row>
          );
